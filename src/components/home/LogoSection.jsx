...
const LogoSection = () => {
  ...
  useEffect(() => {
    ...
    const handleScrollEnd = () => {
      if (
        logoContainer.scrollLeft >=
        logoContainer.scrollWidth - logoContainer.clientWidth
      ) {
  ...
  return (
    <div className="logo-slider font-[Poppins] text-[13px] md:pt-8 pt-4 md:pl-14 md:pr-14  pl-3 pb-4 md:pb-8 ">
      <div
        className="flex items-center logo-container pl-10 "
        ref={logoContainerRef}
      >
        <div className="logo text-[#fff] md:m-4 m-2 w-[300px] h-[80px] border border-[#0C0C0C] hover:bg-[#0C0C0C] cursor-pointer  flex items-center justify-center rounded-xl bg-[#0C0C0C]">
          Logos
        </div>
        <div className="logo text-[#fff] md:m-4 m-2 w-[300px] h-[80px] border border-[#0C0C0C] hover:bg-[#0C0C0C] cursor-pointer  flex items-center justify-center rounded-xl bg-[#0C0C0C]">
          Logos
